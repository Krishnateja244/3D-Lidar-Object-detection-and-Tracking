...
class Viewer:
    ...
    def __init__(self,box_type = "OpenPCDet",bg=(255, 255, 255)):
        ...
        Args:
            box_type : Defaults to OpenPCDet: (x, y, z, l, w, h, yaw)
            bg : Defaults to (255, 255, 255).
        """
    ...
    def set_ob_color_map(self,color_map_name='rainbow'):
        ...
        Args:
            color_map_name (str, optional): Defaults to 'rainbow'.
    ...
    def set_ego_car(self,ego_car_path = "./ego_car.3ds"):
        ...
        Args:
            ego_car_path (str, optional): Defaults to "./ego_car.3ds".
        """
    ...
    def set_intrinsic_mat(self,intrinsic_mat):
        ...
        Args:
            intrinsic_mat : Intrinsic camera parameters
        """
    ...
    def set_extrinsic_mat(self,extrinsic_mat):
        ...
        Args:
            extrinsic_mat : Camera Externsic parameters
        """
    ...
    def add_points(self,points,
        ...
        Args:
            ...
            color :  Defaults to (150,150,150).
            scatter_filed : Defaults to None.
            alpha :  Defaults to 1.
            del_after_show : Defaults to 'True'.
            add_to_3D_scene :  Defaults to True.
            add_to_2D_scene :  Defaults to True.
            color_map_name ):  Defaults to "rainbow".
        """
        ...
        for i in range(len(boxes)):
            ...
            if ids is not None:
                ...
                if ob_id in self.tracks_actors_dict.keys():
                    ...
                    self.tracks_actors_dict[ob_id].rotate(ang-previous_ori)
